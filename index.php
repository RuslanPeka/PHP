...
<main>
    <section class="work">
        <?php
            ...
            // 1.2. Создадим переменную для записи имени функций
            $functionName = '';

            // 1.3. Создадим анонимную функцию-фабрику для
            $userFunction = function ($func) use ($functionName)
            {
                $functionName = $func;
                return call_user_func($func);
            };

            // 1.4. Проверим работоспособность функции-фабрики:
